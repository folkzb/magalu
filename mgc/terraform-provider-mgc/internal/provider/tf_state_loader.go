...
func (c *tfStateLoader) applyMgcMap(mgcMap map[string]any, attributes resAttrInfoMap, ctx context.Context, tfState *tfsdk.State, path path.Path) {
...
func (c *tfStateLoader) applyMgcList(mgcList []any, attributes resAttrInfoMap, ctx context.Context, tfState *tfsdk.State, path path.Path) {
	attr := attributes["0"]
...
func (c *tfStateLoader) applyValueToState(mgcValue any, attr *resAttrInfo, ctx context.Context, tfState *tfsdk.State, path path.Path) {
