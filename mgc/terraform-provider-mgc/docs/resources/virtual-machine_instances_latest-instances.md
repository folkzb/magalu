...
page_title: "mgc_virtual-machine_instances_latest-instances Resource - terraform-provider-mgc"
subcategory: ""
description: |-
  Operations with instances, including create, delete, start, stop, reboot and other actions. | latest-instances
---

# mgc_virtual-machine_instances_latest-instances (Resource)
