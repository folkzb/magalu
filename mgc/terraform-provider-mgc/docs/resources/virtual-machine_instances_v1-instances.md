...
page_title: "mgc_virtual-machine_instances_v1-instances Resource - terraform-provider-mgc"
subcategory: ""
description: |-
  Operations with instances, including create, delete, start, stop, reboot and other actions. | v1-instances
---

# mgc_virtual-machine_instances_v1-instances (Resource)
