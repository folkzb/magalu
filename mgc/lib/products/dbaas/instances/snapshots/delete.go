...
func (s *service) Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/dbaas/instances/snapshots/delete"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteContext(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/dbaas/instances/snapshots/delete"), s.client, ctx)
	if err != nil {
		return
	}
...
func (s *service) DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/dbaas/instances/snapshots/delete"), s.client)
	if err != nil {
		return
	}
