...
func (s *service) Update(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Update", mgcCore.RefPath("/network/subnets/update"), s.client, s.ctx)
	if err != nil {
		return
	}
...
func (s *service) UpdateContext(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Update", mgcCore.RefPath("/network/subnets/update"), s.client, ctx)
	if err != nil {
		return
	}
