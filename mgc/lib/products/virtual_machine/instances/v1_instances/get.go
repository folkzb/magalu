...
func Get(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Get", mgcCore.RefPath("/virtual-machine/instances/v1-instances/get"), client, ctx)
	if err != nil {
		return
	}
...
func GetUntilTermination(
	...
	e, ctx, err := mgcHelpers.PrepareExecutor("Get", mgcCore.RefPath("/virtual-machine/instances/v1-instances/get"), client, ctx)
	if err != nil {
		return
	}
