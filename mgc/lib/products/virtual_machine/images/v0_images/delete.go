...
func Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/virtual-machine/images/v0-images/delete"), client, ctx)
	if err != nil {
		return
	}
...
func DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/virtual-machine/images/v0-images/delete"), client)
	if err != nil {
		return
	}
