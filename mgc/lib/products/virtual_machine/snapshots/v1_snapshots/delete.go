...
func Delete(
	...
	exec, ctx, err := mgcHelpers.PrepareExecutor("Delete", mgcCore.RefPath("/virtual-machine/snapshots/v1-snapshots/delete"), client, ctx)
	if err != nil {
		return
	}
...
func DeleteConfirmPrompt(
	...
	e, err := mgcHelpers.ResolveExecutor("Delete", mgcCore.RefPath("/virtual-machine/snapshots/v1-snapshots/delete"), client)
	if err != nil {
		return
	}
