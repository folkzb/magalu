...
type createParams struct {
	...
	Copy string `json:"copy,omitempty" jsonschema_description:"Name of the profile to copy content from. If this parameter is passed, the new Profile will be pre-populated with the contents of the Profile with the specified name" mgc:"positional"`
}
