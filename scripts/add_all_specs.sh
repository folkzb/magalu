...
$BASEDIR/add_specs.sh mke kubernetes https://mke.br-ne-1.jaxyendy.com/docs/openapi-with-snippets.json https://mke.br-ne-1.com/docs/openapi-with-snippets.json
